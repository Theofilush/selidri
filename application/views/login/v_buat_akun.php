                                ...
                                <div class="p-2">
                                    <form class="form-horizontal m-t-20" action="<?php echo site_url('Register/aksi_buatakun'); ?>" method="post">
                                        ...
                                        <div class="form-inline row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-12">
                                                    <input type="Text" class="form-control" name="captcha" maxlength="8"><br>                                                
                                                        <?php 
                                        ...
                                        <div class="form-group m-t-10 mb-0 row">
                                            <div class="col-sm-3 m-t-20">
                                                <a href="<?php echo site_url(); ?>Login" class="text-muted"><i class="mdi mdi-account-circle"></i> Login</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
